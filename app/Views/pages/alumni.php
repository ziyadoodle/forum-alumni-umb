...
<div class="container mt-24 px-4 md:px-20 mx-auto">
    ...
    <div id='recipients' class="p-8 mt-6 lg:mt-0 rounded-lg shadow border bg-white">
        <table id="alumni" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
            <thead>
                <tr>
                    <th data-priority="1">#</th>
                    <th data-priority="2">Username</th>
                    <th data-priority="3">Fullname</th>
                    <th data-priority="4">Email</th>
                    <th data-priority="5">Angkatan</th>
            ...
            <tbody>
                ...
                <?php foreach ($users as $user) : ?>
                    <tr>
                        ...
                        <td class="flex justify-center items-center"><a href="<?= base_url('alumni/' . $user['userid']); ?>" class="badge badge-info text-white hover:bg-blue-500">Detail</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
