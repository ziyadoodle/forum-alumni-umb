<div class="navbar sticky top-0 z-10 bg-white px-4 py-2 lg:px-8 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
    ...
    <div class="navbar-center hidden lg:flex">
        <ul class="menu menu-horizontal px-1 gap-2">
            <li>
                <a href="/home" class="<?= (isset($url) ? (($url == 'home') ? 'bg-base-300 font-semibold' : '') : '') ?>">
                    Home
                </a>
            </li>
            <li>
                <a href="<?= base_url('berita'); ?>" class="<?= (isset($url) ? (($url == 'berita') ? 'bg-base-300 font-semibold' : '') : '') ?>">
                    Berita
                </a>
            </li>
            <li>
                <a href="<?= base_url('donasi'); ?>" class="<?= (isset($url) ? (($url == 'donasi') ? 'bg-base-300 font-semibold' : '') : '') ?>">
                    Donasi
                </a>
            </li>
            <li>
                <a href="<?= base_url('alumni'); ?>" class="<?= (isset($url) ? (($url == 'alumni') ? 'bg-base-300 font-semibold' : '') : '') ?>">
                    Cari Alumni
                </a>
            </li>
        </ul>
    ...
    <div class="navbar-end gap-4">
        ...
        <?php else : ?>
            <div class="hidden lg:inline-block lg:items-center dropdown dropdown-end">
                <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                    <div class="w-10 border-2 border-gray-900 rounded-full">
                        <img alt="user-image" src="<?= base_url(); ?>images/user_images/<?= user()->user_image; ?>" />
                    </div>
                </div>
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                ...
                <?php else : ?>
                    <li class="pt-2">
                        <a href="<?= base_url('profile'); ?>" class="select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                            </svg>
                            Profile
                    ...
                    <li class="pt-2">
                        <a href="<?= base_url('logout'); ?>" class="select-none rounded-lg bg-gradient-to-tr from-gray-900 to-gray-800 py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-gray-900/10 transition-all hover:shadow-lg hover:shadow-gray-900/20 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
                                <path fill-rule="evenodd" d="M16.5 3.75a1.5 1.5 0 0 1 1.5 1.5v13.5a1.5 1.5 0 0 1-1.5 1.5h-6a1.5 1.5 0 0 1-1.5-1.5V15a.75.75 0 0 0-1.5 0v3.75a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V5.25a3 3 0 0 0-3-3h-6a3 3 0 0 0-3 3V9A.75.75 0 1 0 9 9V5.25a1.5 1.5 0 0 1 1.5-1.5h6ZM5.78 8.47a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 0 0 0 1.06l3 3a.75.75 0 0 0 1.06-1.06l-1.72-1.72H15a.75.75 0 0 0 0-1.5H4.06l1.72-1.72a.75.75 0 0 0 0-1.06Z" clip-rule="evenodd" />
                            </svg>
                            Log Out
